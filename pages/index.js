        ...
        <div>
          <div>
            <div className="flex justify-between bg-dlgrey flex-col md:flex-row py-16">
              ...
              <div className="w-5/6 md:w-1/2 md:mx-0 mx-auto">
                ...
                {headerFields.text.split("\n").map((para, idx) => <p key={idx} className="text-lg text-black xl:text-xl lg:text-lg">
                  {para}
                </p>)}

              </div>
              <div className="my-4 md:my-auto md:mx-3 mx-auto flex justify-center flex-col">
                <img src={headerFields.image.sourceUrl} height="200" width="200" className="self-center" />
          ...
          <div>
            ...
            <div className="container w-2/3 mx-auto">
              <p>Alongside my business partner, I run <a href="https://spin-up.io">SpinUp</a>. We work alongside clients to build functional prototypes to help them test ideas and attract users and funding. While working with clients and code, I'm constantly noting down what I think other developers would find helpful and useful.</p>
              <p>On this site, you'll find a collection of posts, courses and materials that I have created to help you take your development journey to the next level.</p>
              <p>Below, I've got pointers to some topics I'm currently excited about. Have a look!</p>
              <p>You could also:</p>
              <ul>
                <li><Link href="/about">Find out more about me</Link></li>
                <li><Link href="/mentoring">Book a 1:1 mentoring session</Link></li>
                <li><Link href="/blog">Look through all of my posts</Link></li>
                <li><Link href="/garden">Have a stroll around my digital garden</Link></li>
              </ul>
            </div>
          </div>
          <hr />
