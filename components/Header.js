...
export default function Header() {
  const router = useRouter();
  return (
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 bg-white p-4 flex justify-around md:justify-between">
      <div className="mx-0 md:mx-12">
        <Image src="/brain.svg" height="40" width="40" />
      </div>
      <div className="flex lg:w-1/5 md:w-1/3 w-1/2 ml-6 justify-between ">
        <ActiveLink href="/">
